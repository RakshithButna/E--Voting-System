<html>
<head>
    <title>Contact Us | Evoting</title>
...
<div class="about-section">
    ...
    <p>Help us improving this site...</p>
    <p>Send your suggestions at sharingandeku@gmail.com</p>
  </div>
  <h2 id="ot">Our Team</h2>
  <div class="text">
    <div class="card">
        <div id="one">
  <h2>Susmitha yeddula</h2>
  <p>CEO & Founder</p>
  <p>Student at VIT</p>
  <p> <a href = "mailto: yeddulasusmitha@gmail.com">Email</a></p>
  </div></div>
</div>
<div class="text">
    <div class="card">
        <div id="one">
            <h2>Vasa sai nivas</h2>
            <p>Web Designer</p>
            <p>Student at VIT</p>
            <p> <a href = "mailto: vasa.sainivas2018@vitstudent.ac.in">Email</a></p>
  </div></div>
</div>
